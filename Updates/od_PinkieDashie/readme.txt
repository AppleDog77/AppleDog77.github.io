...
Ver 1.5 - Added Humongous Entertainment's series to the games responses, added necessary stuff to BootEnd and NameTeach, added a continuous petting minigame to 'em, added mouse wheel petting, fixed the broken chains, added more links, added a new envelope, and allowed 'em to communicate with the Narrator, my second ghost. Also, the Pixar Planet forums are not even viewable anymore (except through the Wayback Machine). (Thur, Mar 30, 2023)
